...
void tetrominoShiftLeft(Tetromino *t, Play_area *p); /*Tested: Yes */

/* Clears the current tetromino location, increments the x-coord, then copies back to the arena */
void tetrominoShiftRight(Tetromino *t, Play_area *p); /*Tested: Yes */
