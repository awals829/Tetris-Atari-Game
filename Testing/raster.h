...
/* Assembly function from setVid.s which sets ("swaps") the current screen frame buffer */
extern  void set_vid_base(UINT16 *);
 ...
 * @name    getVideoBase
 * 
 * @brief   Assembles the video base frame buffer address to allow
 *          printing to the screen.
 * @return  A pointer to the assembled screen address.
 * 
 * @note    This function replaces the Physbase() call.
 * 
*/
UINT16* getVideoBase();
 ...
 * @name    setVideoBase
 * 
 * @brief   Swaps the video base to the parameter base.
 * 
 * @note    This function replaces the setScreen() call for swapping 
 *          screens for double buffering.
 * 
*/
...
/**
 * @name    plotSplashScreen
 * 
 * @param   base - Pointer to screen buffer address in memory.
 * @param   bitmap - pointer to a bitmap to render to a 640x400 pixel screen.
 * 
 * @brief   Assembles the video base frame buffer address to allow
 *          printing to the screen.
 * 
 * @note    Assumes a valid bitmap size and pointer to a starting (top left) screen address.
 * 
*/
